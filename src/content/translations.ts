import { BookOpen, Brain, Dumbbell, Globe2, Landmark, Laptop, Palette, Users } from "lucide-react";
...
export const translations = {
  kr: {
    ...
    programs: [
      { title: "Syans ak Matematik", description: "Eksperyans, lojik, ak rezolisyon pwoblèm pou bati lespri syantifik.", icon: Brain },
      { title: "Literati ak Lang", description: "Kreyòl, franse, ekspresyon oral, ak lekti kritik pou kominike ak klète.", icon: BookOpen },
      { title: "Teknoloji ak Enfòmatik", description: "Konpetans dijital debaz, rechèch, ak itilizasyon teknoloji avèk responsablite.", icon: Laptop },
      { title: "Atizay ak Kilti", description: "Mizik, desen, istwa lokal, ak fyète nan eritaj ayisyen an.", icon: Palette },
    ...
    classes: { title: "Klas ki ap ouvri pou ane 2026-2027", text: "Nou kòmanse ane a ak klas preskolè yo ansanm ak premye sik fondamantal la. Chak kat montre lis liv, founiti, ak frè lekòl pou fanmi yo ka prepare alè.", feeLabel: "Frè total", paymentsLabel: "Vèsman", booksLabel: "Liv ak materyèl", suppliesLabel: "Founiti", viewLabel: "Mande enfòmasyon" },
  ...
  fr: {
    ...
    programs: [
      { title: "Sciences et Mathématiques", description: "Expériences, logique et résolution de problèmes pour bâtir l'esprit scientifique.", icon: Brain },
      { title: "Littérature et Langues", description: "Créole, français, expression orale et lecture critique pour communiquer clairement.", icon: BookOpen },
      { title: "Technologie et Informatique", description: "Compétences numériques, recherche et usage responsable de la technologie.", icon: Laptop },
      { title: "Arts et Culture", description: "Musique, dessin, histoire locale et fierté de l'héritage haïtien.", icon: Palette },
    ...
    classes: { title: "Classes ouvertes pour l'année 2026-2027", text: "Nous lançons l'année avec le préscolaire et le premier cycle fondamental. Chaque carte présente les livres, fournitures et frais de scolarité afin d'aider les familles à se préparer.", feeLabel: "Frais total", paymentsLabel: "Versements", booksLabel: "Livres et matériel", suppliesLabel: "Fournitures", viewLabel: "Demander des infos" },
